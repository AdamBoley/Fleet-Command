...
Correction - Drastically reduce supplies to a starting count of 50 or so. This should ensure that a player using the scenario described above will run out of supplies around mission 4 or 5<br>
